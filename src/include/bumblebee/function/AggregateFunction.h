...
public:
    AggregateFunction(const string &name,const std::vector<ConstantType> &arguments, ConstantType result,
...
public:
    ...
    static AggregateFunction unaryAggregate(const string &name,const std::vector<ConstantType> &arguments, ConstantType result) {
